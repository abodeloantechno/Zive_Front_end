    ...
    <section id="about" className="py-20 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {[
            { icon:<FaHeart className="text-white" size={32} />, title: "WHY ?", desc: "We nurture and elevate human life, aiming to end chronic illness for good.", color: "cyan", delay: 0 },
            {icon: <FaRobot className="text-white" size={32} />, title: "HOW ?", desc: "Direct AI-powered and expert-guided personalization—no fads, no confusion, just clear science and support.", color: "yellow", delay: 200 },
            {icon: <FaBullseye className="text-white" size={32} />, title: "WHAT ?", desc: "Nutrition, fitness, and meditation crafted daily, just for you.", color: "pink", delay: 400 }
          ].map((item, index) => (
            <MotionDiv 
              key={index}
